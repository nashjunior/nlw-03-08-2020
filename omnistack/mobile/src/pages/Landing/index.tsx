  ...
  return (
    <View style={styles.container}>
      ...
      <View style ={styles.buttonContainer}>
        <RectButton style={[styles.button, styles.buttonPrimary]} onPress={handleNavigateToStudyingPage}>
      ...
      <Text style={styles.totalConnections} >Total de  200 Conexoes ja reealizadas {' '}
